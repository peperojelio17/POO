    ...
    internal class Juego
    {
        ...
        public void dibujar()
        {
            ...
            foreach (var t in terreno)
            {
                ...
                Console.ForegroundColor = marcada ? ConsoleColor.Green : ConsoleColor.White;
                if (rota) Console.WriteLine(t.Value);
        ...
        private void presionar() 
        {
            foreach (var t in terreno)
            {
                ...
                {
                    romper(t);
                    posicionesRotas.Add(new Posicion(t.Key.X, t.Key.Y));
                    if (t.Value == "0")
                    {
                        colorJugador = ConsoleColor.Green;
                    }
                    else colorJugador = ConsoleColor.Red;
                }
            }
        }
